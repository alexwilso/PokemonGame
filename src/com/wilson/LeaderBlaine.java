...
class BlaineAI{
    /* Responsible for determining move to be used by Leader Blaine. Creates attack tree for Rapidash, Flareon, and
      Growlithe to determine the attack to be used by each. */
    ...
    public Map<Integer, String> CreateTreeFlareon(LeaderBlaine leaderBlaine, Flareon flareon, int enemyHealth,
        ...
        /* Creates search tree based on input of flareon's health and status of enemy. Calls FlareonAttack to
    ...
    public Map<Integer, String> CreateTreeRapidash(LeaderBlaine leaderBlaine, Rapidash rapidash, int enemyHealth,
                                                  String enemyType, String enemyStatus) {
        /* Creates search tree based on input of rapidash's health and status of enemy. Calls RapidashAttack to
        determine, damage done with attack. Returns hashmap with string and damage as values. */
    ...
    public Map<Integer, String> CreateTreeGrowlithe(LeaderBlaine leaderBlaine, Growlithe growlithe, int enemyHealth,
                                                   String enemyType, String enemyStatus) {
        /* Creates search tree based on input of growlithe's health and status of enemy. Calls GrowlitheAttack to determine,

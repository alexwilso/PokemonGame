...
class GiovanniAI {
    /* Responsible for determining move to be used by Leader Erika. Creates attack tree for Dugtrio, Rhyhorn, and
      Nidoqueen to determine the attack to be used by each. */
    ...
    public Map<Integer, String> CreateTreeDugtrio(LeaderGiovanni leaderGiovanni, Dugtrio dugtrio, int enemyHealth, String enemyType, String enemyStatus) {
       /* Creates search tree based on input of dugtrio's health and status of enemy. Calls DugtrioAttack to
                ...
                switch (random) {
                    ...
                    case 4:
                        if (rhyhorn.getHornAttack().getPp() > 0) {
                            ...
                            break; }break; }
                return GiovanniAttackRhyhorn(leaderGiovanni, rhyhorn, randomMove, enemyType); } return 0; }
    ...
    public Map<Integer, String> CreateTreeNidoqueen(LeaderGiovanni leaderGiovanni, Nidoqueen nidoqueen, int enemyHealth, String enemyType, String enemyStatus) {
       /* Creates search tree based on input of Nirdoqueen's health and status of enemy. Calls NidoqueenAttack to
        determine, damage done with attack. Returns hashmap with string and damage as values. */

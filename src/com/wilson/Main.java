...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        RivalAI rivalAI = new RivalAI(binaryTree);
        ...
        RivalBattle rivalBattle = new RivalBattle(returnMove, playerMove, pokemonStatus, battlemenu, rivalAI);
        Bulbasaur bulbasaur = new Bulbasaur("Bulbasuar", "Grass",50, 115,115,
                "Normal", new VineWhip(35, 5, 5), new SludgeBomb(10, 15,15),
        ...
        Charmander charmander = new Charmander("Charmander", "Fire", 50, 120, 120, "Normal",
                new Scratch(20, 25, 25), new Ember(20, 10,10, pokemonStatus),
                new Flamethrower(30, 5, 5, pokemonStatus), new Tailwhip(10,25,25), battlemenu);
        ...
        Onix onix = new Onix("Onix", "Rock", 50, 140, 140, "Normal",
                new Rage(20,20,20), new RockThrow(25,10,10),
        ...
        Pikachu pikachu = new Pikachu("Pikacu", "Electric", 50, 120, 120, "Normal",
                new QuickAttack(20,25,25), new ThunderShock(20,15,15, pokemonStatus),
                new Thunder(30,5,5, pokemonStatus), new Growl(10,20,20), battlemenu);
...
//        Object[] rivalPokemon = new Object[3];
        ...
        System.out.println("Professor Oak: So you selected " + pokemon[0] + ", " + pokemon[1] + ", and " + pokemon[2] + "! " + "All great pokémon!"); // Fix this, returning objects
        System.out.println(rivalName + ": I'll take " + pokemon[3] + ", " + pokemon[4] + ", and " + pokemon[5] + " then! My pokémon are a lot tougher than yours!");
        System.out.println("Professor Oak: " + rivalName + " also very good pokémon! I'm sure you guys will get to battle soon enough... Now let me explain how this world works.\n" +
                ...
                "items from the store to help your pokémon in battle! \nLets check it out before we send you on your way...\n" );
...
//         Celadon city gym battle
        ...
        if (!viridianCityGym.Welcome(player, pokemon)){
            System.out.println("Professor Oak: Looks like you were defeated. Maybe next time you should try different pokemon. Thanks " +
                    "for stopping by " + name + ", be sure to come by when you're ready to try again!");
            System.exit(0);}
        System.out.println("Professor Oak: Wow very impressive! Looks like you're the best of the best...");
        battlemenu.pressAnyKeyToContinue();
        ...
        System.out.println(rivalName + " sent out " + pokemon[3]);

        // Rival battle
        rivalBattle.Battle(rival, player, pokemon);
    }
    ...
    public static void visitStore(Store store, Player player, Scanner scanner) {
        ...
        do {
            ...
            System.out.println("Enter number of option you wish to do...");
